...
Sempre consulte os documentos de referência em `ai_artifacts/logica_de_calculo.md`. Use estritamente o **Strategy Pattern** e crie testes limpos (TDD) para validar que os limiares lógicos (ex: `indice_esgotamento >= 2.0`) acionam a resposta correta.
